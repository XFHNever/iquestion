...
class TagController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','selectTag'),
				'users'=>array('*'),
			),
	...
	public function actionIndex()
	{
            ...
            $this->tag = Tag::model()->findByPk(1);
            
            
            $criteria = new CDbCriteria();
            $criteria->addCondition('tag_id=1');
            
            $this->questions = Question::model()->findAll($criteria);
        ...
        public function actionSelectTag($id){
            $this->tags = Tag::model()->findAll();
            $this->tag = Tag::model()->findByPk($id);
            
            $criteria = new CDbCriteria();
            $criteria->addCondition('tag_id='. $id);
